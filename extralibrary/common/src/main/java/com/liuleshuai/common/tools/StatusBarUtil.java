...
public class StatusBarUtil {
    ...
    public static void immersive(Window window, int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            setFakeStatusBar((ViewGroup) window.getDecorView(), color, alpha);
     ...
     * 判断是否Flyme4以上
     */
    private static Pattern pattern = Pattern.compile("Flyme OS [4|5]", Pattern.CASE_INSENSITIVE);
     ...
     * 创建假的透明栏
     */
    public static void setFakeStatusBar(ViewGroup container, int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
